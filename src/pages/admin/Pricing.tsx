      ...
      <div className="p-4 lg:p-6 max-w-4xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl lg:text-2xl font-bold text-white">Fiyatlandırma</h1>
              <p className="text-gray-400 text-sm hidden sm:block">Tüm sürücüler için km bazlı ücret ve platform komisyonu</p>
            </div>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="space-y-4 lg:space-y-6">
            {/* Ana Ayarlar */}
            <div className="bg-gray-800 border border-gray-700 rounded-2xl p-4 lg:p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    className="w-full bg-gray-700 border border-gray-600 rounded-xl px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 text-lg"
                    value={cfg.currency}
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      step="0.01"
                      min={0}
                      className="w-full bg-gray-700 border border-gray-600 rounded-xl pl-4 pr-14 py-3 text-white text-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      min={0}
                      max={100}
                      className="w-full bg-gray-700 border border-gray-600 rounded-xl pl-4 pr-12 py-3 text-white text-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <div className="bg-gray-800 border border-gray-700 rounded-2xl p-4 lg:p-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                {/* Platform Kazancı */}
                <div className="bg-gradient-to-br from-yellow-900/30 to-amber-800/20 rounded-xl p-4 border border-yellow-700/30">
                  <div className="flex items-center gap-2 mb-2">
                    <DollarSign className="h-5 w-5 text-yellow-400" />
                    <span className="text-sm text-gray-400">Platform Kazancı (km)</span>
                  </div>
            ...
            {/* Örnek Senaryo */}
            <div className="bg-gradient-to-r from-blue-900/30 to-purple-900/30 border border-blue-700/50 rounded-2xl p-4 lg:p-6">
              <h2 className="text-base lg:text-lg font-semibold text-white mb-4 flex items-center gap-2">
                <Calculator className="h-5 w-5 text-purple-400" />
                Örnek: 10 km Yolculuk
              </h2>

              <div className="grid grid-cols-3 gap-3 lg:gap-4">
                <div className="text-center p-3 lg:p-4 bg-gray-800/50 rounded-xl">
                  <p className="text-xs text-gray-400 mb-1">Şoför</p>
            ...
            <div className="flex gap-3">
              <button
                onClick={handleSave}
                disabled={saving}
                className="flex-1 flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 disabled:bg-gray-600 py-3.5 text-lg font-medium text-white rounded-xl transition-colors"
              >
                {saving ? (
                  <>
              ...
              <button
                ...
                disabled={loading}
                className="flex items-center justify-center gap-2 border border-gray-600 text-gray-300 hover:bg-gray-700 py-3.5 px-5 rounded-xl transition-colors"
              >
