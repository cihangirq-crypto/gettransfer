...
const DriverEarningsLazy = React.lazy(() => import('@/pages/driver/Earnings').then(m => ({ default: m.DriverEarnings })));
...
const AdminAccountingLazy = React.lazy(() => import('@/pages/admin/Accounting').then(m => ({ default: m.AdminAccounting })));
